...
let library_type =
  ...
  ("tan", Type.Fun([Type.Float], Type.Float));
...
let rec deref_term = function
  ...
  | SRA(e1, e2) -> SRA(deref_term e1, deref_term e2)
...
let rec g env e = (* 型推論ルーチン (caml2html: typing_g) *)
  try
	...
	Type.Int
    | Add(e1, e2) | Sub(e1, e2) | Mul(e1, e2) | Div(e1, e2) | SLL(e1, e2) | SRA(e1, e2) -> (* 整数演算の型推論 (caml2html: typing_add) *)
	unify Type.Int (g env e1);
	unify Type.Int (g env e2);
	Type.Int
    | FAbs(e) | FNeg(e) | SqRt(e) | Floor(e) | FInv(e) ->
